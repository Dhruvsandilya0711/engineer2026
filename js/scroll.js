...
export function initScroll() {
  ...
  ready = (async () => {
    ...
    try {
      ({ gsap } = await import('/engineer2026/vendor/gsap/index.js'));
      ({ ScrollTrigger } = await import('/engineer2026/vendor/gsap/ScrollTrigger.js'));
    } catch {
    ...
    try {
      const { default: Lenis } = await import('/engineer2026/vendor/lenis/lenis.mjs');
      lenis = new Lenis({
        duration: 1.05,
